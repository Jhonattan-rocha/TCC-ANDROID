...
export default function ChamadoEscolhido(props){
    ...
    return (
        <View>
            <Text style={{color: 'black', fontSize: 14}}>{subcategoriaslist.map(cat => {
                if(cat.id === props.route.params.subcategoria){
            ...
            <View>
                <FlatList
                    ...
                    renderItem={({item}) => {
                        if(item.subcategoria === props.route.params.subcategoria){
                            return (
                                <View>
