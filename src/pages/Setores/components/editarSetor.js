...
function EditarSetores(props){
  ...
  const [responsavel, setResponsavel] = useState(props.setor.responsavel);
  ...
  const handleSave = () => {
    ...
    dispatch(actions.EDITAR_SETORES_REQUEST(newSector))
    setNome('');
    setResponsavel('');
  ...
  return (
        <Modal animationType='slide' visible={props.Visible}>
            ...
            <DropDown onSelected={setResponsavel} defaultValue={responsavel}></DropDown>
